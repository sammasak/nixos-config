...
description: Use when working inside ~/workspace or when a task refers to the ICM workspace, workflows, claude-code-skills, knowledge graph, rooms, or projects routed from workspace/CLAUDE.md. Guides Codex to load the right CLAUDE.md and CONTEXT.md files before acting.
---
...
5. When the task mentions a named workflow, read `~/workspace/workflows/INDEX.md` for discovery and then the matching `~/workspace/workflows/<name>/CONTEXT.md`.
6. When the task mentions `claude-code-skills`, route to `~/workspace/claude-code-skills/CONTEXT.md`.
...
- Use the `workflows/` room for named multi-step procedures.
