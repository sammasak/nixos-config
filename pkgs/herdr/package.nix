# Vendored from nixpkgs to bump herdr to 0.9.0 for the `machine add`
# multi-machine feature; nixpkgs is still on 0.8.2. Drop this and use
# pkgs.herdr directly once nixpkgs catches up.
{
  lib,
  stdenv,
  rustPlatform,
